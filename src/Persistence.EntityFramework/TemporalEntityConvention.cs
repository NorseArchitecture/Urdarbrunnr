...
/// the derived history/timeline names (fails loudly on collision). When the provider binding
/// supplies a <see cref="INorseEfProvider.TemporalRealizationHook"/>, each validated entity is
/// realized immediately after its stamp — one deterministic pass, mirroring how
